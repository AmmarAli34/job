...
import 'package:jobleapconnectnew/jobprivider/home_page/widgets/pmain_page.dart';
...
import 'package:jobleapconnectnew/pages/main/Profile/profile.dart';
...
class _DrawerWidgetState extends State<DrawerWidget> {
  ...
  Future<ProfileCardentail?> getCardentailData() async {
    ...
    var request = http.Request('GET', Uri.parse('http://'));
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          child: FutureBuilder<Uint8List>(
                            ...
                            builder: (context, snapshot) {
                              if (snapshot.connectionState ==
                                ...
                                return Image.memory(
                                    snapshot.data!); // Display image from bytes
                              }
                            },
                          ),
                        ),
                      ...
                      FutureBuilder(
                        ...
                        builder: (context,
                            AsyncSnapshot<ProfileCardentail?> snapshot) {
                          if (!snapshot.hasData) {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => pMainPage()));
                    },
                    child: Row(
                      children: [
                        Icon(Icons.post_add),
